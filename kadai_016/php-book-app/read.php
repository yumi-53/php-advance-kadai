...
try {
  ...
  // orderパラメータの値が存在すれば（並び替えボタンを押したとき）、その値を変数$orderに代入する。ないときNULL
  if (isset($_GET['order'])) {
    $order = $_GET['order'];
  } else {
    $order = NULL;
    ...
    <article class="books">
      ...
      <div class="books-ui">
        <div>
          ...
          <a href="read.php?order=asc&keyword=<?= $keyword ?>"> <img src="images/asc.png" alt="昇順に並び替え" class="sort-img"></a>
